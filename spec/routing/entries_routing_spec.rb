...
describe EntriesController do
  describe 'routing' do
    ...
    it 'routes to #show' do
      get('/entries/1').should_not route_to('entries#show', :id => '1')
    end

    it 'routes to #edit' do
      get('/entries/1/edit').should_not route_to('entries#edit', :id => '1')
    end
    ...
    it 'routes to #update' do
      put('/entries/1').should_not route_to('entries#update', :id => '1')
    end
